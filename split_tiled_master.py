...
"""
./Tiled-MoNuSeg-2018-ImageMask-Dataset-M1
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    images_dir = "./Tiled-MoNuSeg-master/images/"
    masks_dir  = "./Tiled-MoNuSeg-master/masks/"
    output_dir = "./Tiled-MoNuSeg-2018-ImageMask-Dataset-M1/"
